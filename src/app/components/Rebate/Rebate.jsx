...
export default function Rebate({ setActiveComponent }) {
    ...
    const getBinary = async () => {
        ...
        try {
            const response = await axios.get(`${API}/api/v1/sales?page=${currentPage}&page_size=${pageCountRef.current}`, {
    ...
    const handleRebatePage = (name, id) => {
            ...
            <div className={styles.tableSection}>
                <div className={styles.tableIn}>
                    <div className={styles.btnsWrapperAdd}>
                        <button className={styles.addBtn} onClick={() => handleRebatePage('RebateAdd', null)}>
